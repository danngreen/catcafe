...
export const SHOPS = [
  ...
  },
  {
    ...
    greet: "These aren't ordinary cats. The prices reflect that.",
  },
  {
...
export const BOOKS = [
  {
    ...
    text: 'A green book with gold letters, and a spine that has given up.\n\n'
      ...
      + 'the collar."\n\n'
      + '(Somebody has penciled in the margin: "Saltsouth = Saltmere. They renamed it '
  ...
  },
  {
    ...
    text: 'Beautifully illustrated. Deeply unhelpful.\n\n'
      ...
      + 'Someone else has written underneath: "Also, they\'ll sit on the register."',
    flag: 'read_cat_lore',
  },
  {
    id: 'tide_book',
