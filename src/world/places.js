...
export const VILLAGERS = [
  ...
  { id: 'shrimp', name: 'Shrimp', town: 'saltmere', species: 'otter', coat: 'brown', role: 'villager',
    lines: ["Found a lovely shell this morning. Gave it to my mate Moth. "
      + "Not sure he really wanted it, mind.",
    ...
    hint: "That big spiral shell? Moth's got it. Little grey fellow in Brambleford — "
      + "only out after dark, counting things on the lamps." },
  ...
  { id: 'pike', name: 'Pike', town: 'brambleford', species: 'hedgehog', coat: 'grey', role: 'villager',
    when: 'night',
  ...
  { id: 'pim', name: 'Pim', town: 'saltmere', species: 'owl', coat: 'owl', role: 'villager',
    when: 'night',
    lines: ["There's someone I keep meaning to speak to. I keep meaning it very hard.",
  ...
  { id: 'nutmeg', name: 'Nutmeg', town: 'thistlewick', species: 'mouse', coat: 'brown', role: 'villager',
    when: 'night',
    lines: ['I have a job. It is at the mill. It mostly involves being at the mill.',
