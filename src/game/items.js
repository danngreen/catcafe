...
export const ITEMS = {
  ...
  // ------------------------------------------------------------- furniture
  f_chair: { name: 'Wooden Chair', cat: CAT.FURNITURE, icon: 'bag', cost: 55, place: 'chair', seats: 1, appeal: 0.4, desc: 'A place to sit. The foundation of hospitality.' },
  f_stool: { name: 'Padded Stool', cat: CAT.FURNITURE, icon: 'bag', cost: 70, place: 'stool', seats: 1, appeal: 0.5, desc: 'No back, but cheerful.' },
  f_table: { name: 'Round Table', cat: CAT.FURNITURE, icon: 'bag', cost: 110, place: 'tableRound', appeal: 0.6, desc: 'Fits two comfortably, three if they like each other.' },
  f_table_cloth: { name: 'Dressed Table', cat: CAT.FURNITURE, icon: 'bag', cost: 175, place: 'tableCloth', appeal: 1.1, desc: 'The cloth suggests you have standards.' },
  f_table_long: { name: 'Long Table', cat: CAT.FURNITURE, icon: 'bag', cost: 210, place: 'tableSq', appeal: 0.9, desc: 'For groups. Groups order more.' },
  f_sofa: { name: 'Velvet Sofa', cat: CAT.FURNITURE, icon: 'bag', cost: 420, place: 'sofa', seats: 3, appeal: 2.4, desc: 'People stay far too long on this. That is the point.' },
  f_plant: { name: 'Potted Fern', cat: CAT.FURNITURE, icon: 'bag', cost: 90, place: 'plantPot', appeal: 0.9, desc: 'Instantly makes a room look cared for.' },
  f_lamp: { name: 'Floor Lamp', cat: CAT.FURNITURE, icon: 'lantern', cost: 130, place: 'lampIn', appeal: 1.1, light: true, desc: 'Warm pool of light. Essential after dark.' },
  f_painting: { name: 'Landscape Painting', cat: CAT.FURNITURE, icon: 'bag', cost: 160, place: 'painting', appeal: 1.2, wall: true, desc: 'The valley, badly painted, beloved.' },
  f_bookshelf: { name: 'Bookshelf', cat: CAT.FURNITURE, icon: 'book', cost: 240, place: 'bookshelf', appeal: 1.6, desc: 'People browse. Browsing people order tea.' },
  f_fireplace: { name: 'Stone Fireplace', cat: CAT.FURNITURE, icon: 'bag', cost: 680, place: 'fireplace', appeal: 3.2, light: true, desc: 'On a wet afternoon this pays for itself.' },
  f_piano: { name: 'Upright Piano', cat: CAT.FURNITURE, icon: 'bag', cost: 900, place: 'piano', appeal: 3.6, rare: true, desc: 'Somebody always knows three songs.' },
  f_cattower: { name: 'Cat Tower', cat: CAT.FURNITURE, icon: 'bag', cost: 180, place: 'catTower', appeal: 1.0, catJoy: 2, desc: 'The high shelf is the best seat in the house, and everyone knows it.' },
  f_catbed: { name: 'Cat Bed', cat: CAT.FURNITURE, icon: 'bag', cost: 85, place: 'catBed', appeal: 0.6, catJoy: 1.4, desc: 'They will sleep in the box it came in. Then, eventually, in this.' },
  f_scratch: { name: 'Scratching Post', cat: CAT.FURNITURE, icon: 'bag', cost: 95, place: 'scratchPost', appeal: 0.3, catJoy: 1.6, desc: 'Saves the sofa. Worth every fish.' },
  f_bowl: { name: 'Feeding Bowl', cat: CAT.FURNITURE, icon: 'bag', cost: 35, place: 'catBowl', appeal: 0.1, catJoy: 0.6, desc: 'More bowls, fewer arguments.' },
  f_counter: { name: 'Service Counter', cat: CAT.FURNITURE, icon: 'bag', cost: 260, place: 'counter', appeal: 0.5, desc: 'Where the money happens.' },
  ...
  f_rug: { name: 'Woven Rug', cat: CAT.FURNITURE, icon: 'bag', cost: 140, place: 'rug', appeal: 1.0, floor: true, desc: 'Softens the whole room, and the acoustics with it.' },
...
export const STOCK = {
  ...
  furniture: ['f_chair', 'f_stool', 'f_table', 'f_table_cloth', 'f_table_long', 'f_sofa', 'f_plant', 'f_lamp', 'f_painting', 'f_bookshelf', 'f_rug', 'f_case', 'f_machine', 'f_fireplace'],
